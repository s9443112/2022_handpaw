...
class Product(models.Model):
    ...
    _type = models.CharField('型號', max_length=50,default=None, null=True, blank=True)
    ...
    origin = models.CharField('產地', max_length=50,default='TW')
...
class Picture(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE)
    url = models.ImageField(upload_to='images',default=None, null=True, blank=True)  
